      ...
      >
        <View style={styles.dialogContainerStyle}>
          ...
          >
            ...
            >
              <Text style={{ ...Fonts.whiteColor20Bold }}>Cancel</Text>
            </TouchableOpacity>
            <TouchableOpacity
              activeOpacity={0.7}
              onPress={() => {
            ...
            >
              <Text style={{ ...Fonts.blackColor20Bold }}>Logout</Text>
            </TouchableOpacity>
          </View>
        </View>
      </Overlay>
  ...
  function profileSettingOptions() {
    return (
      <>
        ...
        >
          {optionsShort({
            icon: require("../../../assets/images/icons/subscription.png"),
            option: "Subscription Plans",
          })}
        </TouchableOpacity>
        <TouchableOpacity
          activeOpacity={0.7}
      ...
      >
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          ...
          >
            <Text
              numberOfLines={1}
              style={{ lineHeight: 18.0, ...Fonts.blackColor14Bold }}
            >
              Krishna Rai
            </Text>

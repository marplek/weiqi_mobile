import { equals, getNeighbors, add } from './helper.js';
import Board from './pseudoBoard.js';

export function guess(data, { finished = false, iterations = 50 } = {}) {
...
export function playTillEnd(data, sign) {
    let board = new Board(data).clone()
    let freeVertices = []
    let illegalVertices = []
...
export function getProbabilityMap(data, iterations) {
...
export function getFloatingStones(data) {
